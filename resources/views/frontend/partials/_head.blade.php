...
<!-- Page Title -->
<title>Education University Learning Online Course HTML5 Template - LearnPro</title>

<!-- Favicon and Touch Icons -->
<link href="{{asset("frontend/images/favicon.png")}}" rel="shortcut icon" type="{{asset('frontend/image/png')}}">
...
<!-- CSS | Theme Color -->
<link href="{{asset('frontend/css/colors/theme-skin-color-set5.css')}}" rel="stylesheet" type="text/css">
